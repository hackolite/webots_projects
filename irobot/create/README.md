...
A **ceiling camera** (FOV ≈ 86 °, 320 × 320 px) is mounted at (2.5, 1.5, 2.35)
in the bedroom, looking straight down.
...
GET  /robots/{id}                Single robot detail
...
GET  /robots/ceiling/camera      Bedroom ceiling camera as base64 JPEG
                                 Response: {"source": "ceiling", "format": "jpeg", "data": "<b64>"}
```
...
# Get ceiling camera image and decode it
...
`/tmp/webots_ceiling_camera.jpg` by the respective controllers.
